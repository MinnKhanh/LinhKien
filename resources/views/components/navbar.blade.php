    ...
    <div class="navbar-brand-wrapper d-flex justify-content-center">
        <div class="navbar-brand-inner-wrapper d-flex justify-content-between align-items-center w-100">
            <a class="navbar-brand brand-logo d-flex justify-content-start align-items-center"
                href="{{ asset('admin/dashboard') }}"><img src="{{ asset('storage/home/logo.png') }}"
                    style="max-width: 30%;" alt="logo" /><span
                    style="font-size: large; font-weight: 900; margin-left: 1px;">LINK
                    KIEN</span></a>
            <a class="navbar-brand brand-logo-mini" href="{{ asset('admin/dashboard') }}"><img
