...
<div class="container">
    ...
    <form class="row">
        @csrf
        <h4 class="co-6 checkout__input mb-5 border-bottom"> {{ 'Thông tin cửa hàng' }}
        </h4>
        ...
        <div class="col-12 form-row">
            <div class="col-6">
                <div class="checkout__input">
                    ...
                    <input type="text" wire:model.defer="namebank">
                    <p class="error">
                        @error('namebank')
                            <strong>{{ $message }}</strong>
                        @enderror
            ...
            <div class="col-6">
                <div class="checkout__input">
                    ...
                    <input type="text" wire:model.defer="accountbank">
                    <p class="error">
                        @error('accountbank')
                            <strong>{{ $message }}</strong>
                        @enderror
        ...
        <div class="col-12 form-row">
            ...
            <div class="col-6">
                <div class="checkout__input">
                    <p>Tạo độ bản đồ<span>*</span></p>
                    <input type="text" wire:model.defer="coordinates">
                    <p class="error">
                        @error('coordinates')
                            <strong>{{ $message }}</strong>
                        @enderror
        ...
        <div class="col-12 form-row">
            <div class="col-12">
                <div class="checkout__input">
                    <p>Lời nhắn<span>*</span></p>
                    <textarea type="text" wire:model.defer="message"></textarea>
                    <p class="error">
                        @error('message')
                            <strong>{{ $message }}</strong>
                        @enderror
        ...
        <div class="form-group col-12 row justify-content-center btn-group-mto mt-5">
            <div>
                ...
                <button wire:click.prevent="store" type="button" class="btn btn-primary"><i class="fa fa-plus"></i>
                    {{ isset($infor) ? 'Update' : 'Create' }}</button>
