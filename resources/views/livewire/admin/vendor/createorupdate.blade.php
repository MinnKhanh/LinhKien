...
<div class="container">
    ...
    <form class="row">
        ...
        <h4 class="co-6 checkout__input mb-5 border-bottom">
            {{ isset($isedit) ? 'Cập nhật nhà cung cấp' : 'Tạo mới nhà cung cấp' }}
        </h4>
        ...
        <div class="col-12 form-row">
            <div class="col-4">
                <div class="checkout__input">
                    <p>Email<span>*</span></p>
                    <textarea type="text" wire:model.defer="email" placeholder=""></textarea>
                    <p class="error">
                        @error('email')
                            <strong>{{ $message }}</strong>
                        @enderror
            ...
            <div class="col-4">
                <div class="checkout__input">
                    ...
                    <input type="text" wire:model.defer="website" placeholder="">
                    <p class="error">
                        @error('website')
                            <strong>{{ $message }}</strong>
                        @enderror
        ...
        <div class="col-12 form-row">
            ...
            <div class="col-6 form-row">
                <div class="col-12 d-flex justify-content-center" style="height: 10rem">
                    <img src="{{ $photo ? $photo->temporaryUrl() : ($img ? asset('storage/vendor/' . $img) : '') }}"
                        alt="">
                </div>
            </div>
        </div>
        ...
        <div class="form-group col-12 row justify-content-center btn-group-mto mt-5">
            <div>
                <a href="{{ route('admin.vendor.index') }}" class="btn btn-default">
                    <i class="fa fa-arrow-left"></i>
                    Back
                </a>
                <button wire:click.prevent="store" type="button" class="btn btn-primary"><i class="fa fa-plus"></i>
                    {{ isset($isedit) ? 'Câp nhật' : 'Tạo mới' }}</button>
